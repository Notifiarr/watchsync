...
$q[] = "CREATE TABLE IF NOT EXISTS `" . MEDIA_APP_TABLE . "` (
        ...
        `webhooks` int NOT NULL DEFAULT 0,
        PRIMARY KEY (`id`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci";
...
$q[] = "CREATE TABLE IF NOT EXISTS `" . MEDIA_APP_USER_TABLE . "` (
        ...
        `token` text NOT NULL,
        `token_age` int NOT NULL DEFAULT 0,
        `pin` varchar(20) NOT NULL DEFAULT '',
        `pin_required` int NOT NULL DEFAULT 0,
        PRIMARY KEY (`id`),
...
$q[] = "INSERT INTO " . NOTIFICATION_TRIGGER_TABLE . "
        ...
        ('syncWebhook', 'Sync webhook', 'Sent when an incoming webhook is processed', 'media'),
        ('syncOverview', 'Sync overview', 'Sent when a sync job finishes with runtime and counts', 'media'),
...
$q[] = "INSERT INTO " . SETTINGS_TABLE . "
        ...
        ('automaticLibrary', ''),
        ('automaticHistory', ''),
        ('automaticParityInterval', '86400'),
        ('automaticLibraryInterval', '3600'),
        ('automaticHistoryInterval', '43200')";
