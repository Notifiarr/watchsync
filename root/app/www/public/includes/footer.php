...
<footer class="app-footer fixed-bottom border-top bg-body d-flex align-items-center">
    <div class="container-fluid small">
        <div class="row align-items-center g-0">
            <div class="col"></div>
            <div class="col-auto">
                © <?= htmlEscape(translate('copyrightNotice', [date('Y'), APP_NAME])) ?>
            </div>
            <div class="col"></div>
        </div>
    </div>
...
<div class="toast-container bottom-0 end-0 p-3" style="z-index: 10002 !important; position: fixed;"></div>
