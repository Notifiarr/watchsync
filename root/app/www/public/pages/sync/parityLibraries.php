                                                                        ...
                                                                        <th>
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <?php if ($isMaster && $appLibraryTotal && $online) { ?>
                                                                                                            <input class="form-check-input me-2 parity-select-all" type="checkbox" id="syncParityLibraryAll-<?= intval($syncApp['id']) ?>" data-kind="library" data-app="<?= intval($syncApp['id']) ?>"<?= $appLibraryChecked && $appLibraryChecked == $appLibraryTotal ? ' checked' : '' ?>>
                                            ...
                                            <?php for ($index = 0; $index < $rowCount; $index++) { ?>
                                                                        <tr>
                                                                            <?php foreach ($syncLibraries as $syncApp) {
                                                                                ...
                                                                                ?>
                                                                                                        <td class="parity-item" style="cursor: pointer;" data-kind="library" data-app="<?= intval($syncApp['id']) ?>" data-id="<?= htmlEscape($syncLibrary['key']) ?>" data-master="<?= $isMaster ? '1' : '0' ?>" data-link="<?= htmlEscape($linkId) ?>" data-sort="<?= intval($index) ?>"<?= $online ? '' : ' data-offline="1"' ?>>
