                                        ...
                                        <th>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <?php if ($isMaster && $appLibraryTotal && $online) { ?>
                                                            ...
                                                            <input class="form-check-input ms-2 parity-select-all" type="checkbox" id="syncParityLibraryAll-<?= intval($syncApp['id']) ?>" data-kind="library" data-app="<?= intval($syncApp['id']) ?>"<?= $appLibraryChecked && $appLibraryChecked == $appLibraryTotal ? ' checked' : '' ?>>
                                                <?php } else { ?>
