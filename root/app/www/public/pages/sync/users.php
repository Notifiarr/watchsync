                                                                                ...
                                                                                <th>
                                                                                    <div class="d-flex align-items-center">
                                                                                        ...
                                                                                        <?php if ($isMaster && $appUserTotal && $online) { ?>
                                                                                                                        <input class="form-check-input me-2 parity-select-all" type="checkbox" id="syncUserAll-<?= intval($syncApp['id']) ?>" data-type="user" data-app="<?= intval($syncApp['id']) ?>"<?= $appUserChecked && $appUserChecked == $appUserTotal ? ' checked' : '' ?>>
                                                ...
                                                <?php for ($index = 0; $index < $rowCount; $index++) { ?>
                                                                                <tr>
                                                                                    <?php foreach ($syncUsers as $syncApp) {
                                                                                        ...
                                                                                        ?>
                                                                                                                    <td class="parity-item" style="cursor: pointer;" data-type="user" data-app="<?= intval($syncApp['id']) ?>" data-id="<?= intval($syncUser['id']) ?>" data-master="<?= $isMaster ? '1' : '0' ?>" data-link="<?= $linkId ?>" data-sort="<?= intval($index) ?>"<?= $online ? '' : ' data-offline="1"' ?>>
