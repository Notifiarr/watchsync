                                        ...
                                        <th>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <?php if ($isMaster && $appUserTotal && $online) { ?>
                                                            ...
                                                            <input class="form-check-input ms-2 parity-select-all" type="checkbox" id="syncUserAll-<?= intval($syncApp['id']) ?>" data-kind="user" data-app="<?= intval($syncApp['id']) ?>"<?= $appUserChecked && $appUserChecked == $appUserTotal ? ' checked' : '' ?>>
                                                <?php } else { ?>
