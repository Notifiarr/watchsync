            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="settings-sync" role="tabpanel">
                        ...
                        <h2 class="h5"><?= htmlEscape(translate('logging')) ?></h2>
                        <div class="mb-4">
                            <select class="form-select" id="syncLogLevel">
                                <option value="info"<?= ($syncSettings['logLevel'] ?? 'info') == 'info' ? ' selected' : '' ?>><?= htmlEscape(translate('logLevelInfo')) ?></option>
                                <option value="debug"<?= ($syncSettings['logLevel'] ?? '') == 'debug' ? ' selected' : '' ?>><?= htmlEscape(translate('logLevelDebug')) ?></option>
                            </select>
                        </div>
