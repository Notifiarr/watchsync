...
$libraryLibs    = $masterApp ? $database->getMediaAppLibraries($masterApp['id']) : [];
        ...
        <div class="card border shadow-sm">
            <div class="card-body">
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <label for="libraryLibrary" class="form-label"><?= htmlEscape(translate('libraries')) ?></label>
                        <select class="form-select" id="libraryLibrary">
                            <option value=""><?= htmlEscape(translate('allLibraries')) ?></option>
                            <?php foreach ($libraryLibs as $libraryLib) {
                                $libKey = strval($libraryLib['key'] ?? '');
                                if ($libKey == '') {
                                    continue;
                                }
                                ?>
                                                            <option value="<?= htmlEscape($libKey) ?>"><?= htmlEscape($libraryLib['title'] ?? $libKey) ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <label for="libraryWatched" class="form-label"><?= htmlEscape(translate('watched')) ?></label>
                        <select class="form-select" id="libraryWatched">
                            <option value="all"><?= htmlEscape(translate('allWatched')) ?></option>
                            <option value="never"><?= htmlEscape(translate('never')) ?></option>
                            <option value="started"><?= htmlEscape(translate('started')) ?></option>
                            <option value="completed"><?= htmlEscape(translate('completed')) ?></option>
                        </select>
                    </div>
                </div>
